...
const CACHE = 'amv-shell-1hyxlvg';
const SHELL = '/';
const ASSETS = new Set(["/manifest.webmanifest","/icon-192.png","/icon-512.png","/amv-bridge.mjs","/i18n/ar.json","/i18n/bn.json","/i18n/de.json","/i18n/es.json","/i18n/fr.json","/i18n/hi.json","/i18n/id.json","/i18n/it.json","/i18n/ja.json","/i18n/ko.json","/i18n/pt.json","/i18n/ru.json","/i18n/ta.json","/i18n/tr.json","/i18n/ur.json","/i18n/vi.json","/i18n/zh.json"]);
