...
const SYS = [
  ...
  "",
  "YOU ARE A COMPLETE WORKSPACE IN CHAT: right here in the conversation you can write & run code, build live interactive HTML/3D, design full websites and UIs, analyze files and data with charts, and plan/execute multi-step work. The dedicated tabs (Studio, Dev, Lab) are optional specialized surfaces - but the user can ask for ANY of it directly in chat and you deliver it inline. Never tell the user to 'go to another tab' to get something done; do it here.",
...
/* ============================================================
   LANGUAGES - UI + AI responses + generated content (3D models,
   documents, code) all honor the user's chosen language. Auto
   means: match whatever language the user writes in.

   It used to say "images, video, models". Image and video generation were
   removed from AMV end to end, and this comment outlived them - which is how
   the translations below came to outlive them too.
   ============================================================ */
const LANGS = {
...
const I18N = {
  ...
  'Choose the language for AMV\u2019s responses and the content it generates - chat replies and 3D models will all use it. You can still ask for any other language inside a message.':{es:'Elige el idioma para las respuestas de AMV y el contenido que genera: respuestas de chat y modelos 3D lo usar\u00e1n. Puedes pedir otro idioma dentro de un mensaje.',ar:'\u0627\u062e\u062a\u0631 \u0644\u063a\u0629 \u0631\u062f\u0648\u062f AMV \u0648\u0627\u0644\u0645\u062d\u062a\u0648\u0649 \u0627\u0644\u0630\u064a \u064a\u0646\u0634\u0626\u0647 - \u0633\u062a\u0633\u062a\u062e\u062f\u0645\u0647\u0627 \u0631\u062f\u0648\u062f \u0627\u0644\u0645\u062d\u0627\u062f\u062b\u0629 \u0648\u0627\u0644\u0646\u0645\u0627\u0630\u062c. \u064a\u0645\u0643\u0646\u0643 \u0637\u0644\u0628 \u0623\u064a \u0644\u063a\u0629 \u0623\u062e\u0631\u0649 \u062f\u0627\u062e\u0644 \u0627\u0644\u0631\u0633\u0627\u0644\u0629.',fr:'Choisissez la langue des r\u00e9ponses d\u2019AMV et du contenu g\u00e9n\u00e9r\u00e9 - r\u00e9ponses et mod\u00e8les 3D l\u2019utiliseront. Vous pouvez demander une autre langue dans un message.',de:'W\u00e4hle die Sprache f\u00fcr AMVs Antworten und generierte Inhalte - Chat-Antworten und 3D-Modelle nutzen sie. Du kannst in einer Nachricht jede andere Sprache anfordern.',zh:'\u9009\u62e9 AMV \u56de\u590d\u548c\u751f\u6210\u5185\u5bb9\u7684\u8bed\u8a00--\u804a\u5929\u56de\u590d\u548c 3D \u6a21\u578b\u90fd\u4f1a\u4f7f\u7528\u5b83\u3002\u4f60\u4ecd\u53ef\u5728\u6d88\u606f\u4e2d\u8981\u6c42\u5176\u4ed6\u8bed\u8a00\u3002',hi:'AMV \u0915\u0940 \u092a\u094d\u0930\u0924\u093f\u0915\u094d\u0930\u093f\u092f\u093e\u0913\u0902 \u0914\u0930 \u0938\u093e\u092e\u0917\u094d\u0930\u0940 \u0915\u0947 \u0932\u093f\u090f \u092d\u093e\u0937\u093e \u091a\u0941\u0928\u0947\u0902\u0964',pt:'Escolha o idioma das respostas do AMV e do conte\u00fado gerado - respostas e modelos 3D o usar\u00e3o. Voc\u00ea pode pedir outro idioma em uma mensagem.',ja:'AMV\u306e\u5fdc\u7b54\u3068\u751f\u6210\u30b3\u30f3\u30c6\u30f3\u30c4\u306e\u8a00\u8a9e\u3092\u9078\u629e-\u30c1\u30e3\u30c3\u30c8\u306e\u5fdc\u7b54\u30683D\u30e2\u30c7\u30eb\u306b\u4f7f\u7528\u3055\u308c\u307e\u3059\u3002\u30e1\u30c3\u30bb\u30fc\u30b8\u5185\u3067\u4ed6\u306e\u8a00\u8a9e\u3082\u4f9d\u983c\u3067\u304d\u307e\u3059\u3002',ru:'\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u044f\u0437\u044b\u043a \u043e\u0442\u0432\u0435\u0442\u043e\u0432 AMV \u0438 \u0433\u0435\u043d\u0435\u0440\u0438\u0440\u0443\u0435\u043c\u043e\u0433\u043e \u043a\u043e\u043d\u0442\u0435\u043d\u0442\u0430.'},
